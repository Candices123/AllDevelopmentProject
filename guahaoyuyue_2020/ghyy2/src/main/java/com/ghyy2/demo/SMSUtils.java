...
public class SMSUtils {
    ...
    private static final String APP_SECRET = "4bde51d04f3a";
    private static final String APP_KEY = "1abc0c930a9db9dbd48999d7244c7271";
     ...
     * @return 是否发送成功
     */
    public static final String sendCode(String mobile, String templateId) throws IOException {
        ...
        String obj = JSON.parseObject(responseResult).getString("obj");
